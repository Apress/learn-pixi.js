...
function setup() {
  ...
  for (var i = 0; i < numberOfPillars; i++) {
    ...
    for (var j = 0; j < 8; j++) {
      if (j < startGapNumber || j > startGapNumber + gapSize - 1) {
        var block = u.sprite(id["greenBlock.png"]);
  ...
  var pixieFrames = [id["0.png"], id["1.png"], id["2.png"]];
  ...
  particleStream = d.emitter(300, //The interval
  function () {
    return d.create( //The function
    pixie.x + 8, //x position
    pixie.y + pixie.height / 2, //y position
    function () {
      return u.sprite(dustFrames);
    }, //Particle sprite
...
function play() {
  ...
  var pixieVsBlock = blocks.children.some(function (block) {
  ...
  if (pixieVsBlock && pixie.visible) {
    ...
    d.create(pixie.centerX, pixie.centerY, //x and y position
    function () {
      return u.sprite(dustFrames);
    }, //Particle sprite
    stage, //The parent container
...
//# sourceMappingURL=pixiePerilousness.js.map